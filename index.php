...
<div class="technology">
	<div class="container">		
		...
		<div class="">
			...
			$sql="select blog.bid,blog.bh,blog.bc,blog.bimg,blog.bd,blog.date,blog.ccount,blog.views,user.name from blog INNER JOIN user ON blog.uid=user.id";
